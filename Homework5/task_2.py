...
def repeats(our_str):
    ...
    и добавляет в строку количество к символам с помощью постфикса формата _n.
    :param our_str: входная строка
    :return: строка с результатом
    """
    new_str = ''
    letters_dict = dict.fromkeys([x for x in our_str], 0)
    for x in our_str:
        letters_dict[x] = letters_dict.get(x) + 1
        new_str = new_str + x + '_' + str(letters_dict.get(x))
    return new_str
